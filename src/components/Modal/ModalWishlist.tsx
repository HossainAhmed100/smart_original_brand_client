            ...
            <div className={`modal-wishlist-block`} onClick={closeModalWishlist}>
                ...
                >
                    ...
                    <div className="list-product px-6">
                        {wishlistState.wishlistArray.map((product) => (
                            <div key={product._id} className='item py-5 flex items-center justify-between gap-3 border-b border-line'>
                                ...
                                <div className="remove-wishlist-btn caption1 font-semibold text-red underline cursor-pointer" onClick={() => removeFromWishlist(product._id)}>
                                    Remove
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="footer-modal p-6 border-t bg-white border-line absolute bottom-0 left-0 w-full text-center">
                        <Link href={'/wishlist'} onClick={closeModalWishlist} className='button-main bg-[#fc8934] w-full text-center uppercase'>View All Wish List</Link>
