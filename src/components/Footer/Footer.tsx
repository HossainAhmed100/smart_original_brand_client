                    ...
                    <div className="container">
                        <div className="content-footer py-[60px] flex justify-between flex-wrap gap-y-8">
                            <div className="company-infor basis-1/4 max-lg:basis-full pr-7">
                                ...
                                <div className='flex gap-3 mt-3'>
                                    ...
                                    <div className="flex flex-col ">
                                        <span className=''>hi.smartOriginal@gmail.com</span>
                                        <span className='mt-3'>019-758-592-49</span>
                                        <span className='mt-3 pt-px'>Fulbaria Super Market, City PLaza, Block#A (Ground Floor),shop#88, Dhaka, Bangladesh</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                            <div className="left flex items-center gap-8">
                                <div className="copyright caption1 text-secondary">©2023 OSSP. All Rights Reserved.</div>
